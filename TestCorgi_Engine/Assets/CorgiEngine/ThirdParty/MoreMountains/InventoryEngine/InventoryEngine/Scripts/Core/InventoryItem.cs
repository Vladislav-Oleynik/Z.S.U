...
namespace MoreMountains.InventoryEngine
{
	...
	public class InventoryItemDisplayProperties
	{
		...
		public bool DisplayBuyButton = true;
	}
	...
	public class InventoryItem : ScriptableObject 
	{
		...
		/// if this is true, this item can be bought
		...
		/// whether or not this object can be bought
		public virtual bool IsBuyable { get { return Buyable; } }
		...
		/// <summary>
		/// What happens when the object is bought - override this to add your own behaviors
		/// </summary>
		public virtual bool Buy(string playerID) { return true; }
	}
}
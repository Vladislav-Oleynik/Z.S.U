...
namespace MoreMountains.InventoryEngine
{
	...
	public class InventoryInputManager : MonoBehaviour, MMEventListener<MMInventoryEvent>
	{
		...
		/// the key used to buy item
		public string BuyKey = "joystick button 6";
#endif
		...
		/// the button used to buy an item
		[MMCondition("ManageButtons", true)]
		...
		private bool _isBuyButtonNotNull;
		...
		protected virtual void Start()
		{
			...
			_isEquipUseButtonNotNull = BuyButton != null;
		...
		protected virtual void HandleButtons()
		{
			...
			if (CurrentlySelectedInventorySlot != null)
			{
				...
				if (_isBuyButtonNotNull)
				{
					SetButtonState(BuyButton, CurrentlySelectedInventorySlot.Buyable() && CurrentlySelectedInventorySlot.BuyButtonShouldShow());
				}
			}
			else
			{
		...
		protected virtual void HandleInventoryInput()
		{
			...
			_buyKeyPressed = Input.GetKeyDown(BuyKey);
#endif
		...
		/// <summary>
		/// Triggers the selected slot's buy method
		/// </summary>
